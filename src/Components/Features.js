...
const Features = () => {
  ...
  return (
   <div className="features-container" id="Features"  data-aos="fade-up">
        ...
        <h1 className="primary-heading" Style="font-size:37px; max-width:100%; ">QATTAH FEATURES</h1>
        <p className="secondary-text" id="features-right-p" Style="max-width:900px; padding-bottom:1rem;">
